...
{
  private readonly IStringLocalizer<QuarkIdentityResource> _localizer;

  public LocalizedIdentityErrorDescriber(IStringLocalizer<QuarkIdentityResource> localizer)
  {
